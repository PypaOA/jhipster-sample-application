...
class JobResourceIT {
    ...
    public static Job createEntity(EntityManager em) {
        Job job = new Job().jobTitle(DEFAULT_JOB_TITLE).minSalary(DEFAULT_MIN_SALARY).maxSalary(DEFAULT_MAX_SALARY).state(DEFAULT_STATE);
        return job;
    }
    ...
    public static Job createUpdatedEntity(EntityManager em) {
        Job job = new Job().jobTitle(UPDATED_JOB_TITLE).minSalary(UPDATED_MIN_SALARY).maxSalary(UPDATED_MAX_SALARY).state(UPDATED_STATE);
        return job;
    }
    ...
    void createJob() throws Exception {
        ...
        assertThat(testJob.getState()).isEqualTo(DEFAULT_STATE);
    }
    ...
    void putNewJob() throws Exception {
        ...
        updatedJob.jobTitle(UPDATED_JOB_TITLE).minSalary(UPDATED_MIN_SALARY).maxSalary(UPDATED_MAX_SALARY).state(UPDATED_STATE);
        ...
        assertThat(testJob.getState()).isEqualTo(UPDATED_STATE);
    }
    ...
    void fullUpdateJobWithPatch() throws Exception {
        ...
        partialUpdatedJob.jobTitle(UPDATED_JOB_TITLE).minSalary(UPDATED_MIN_SALARY).maxSalary(UPDATED_MAX_SALARY).state(UPDATED_STATE);
